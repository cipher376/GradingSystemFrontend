...
export class ManagerDashboardComponent implements OnInit {
  ...
  amountToBeCredited = 0.0; // float amount calc from orders in transit
  processedOrdersAmount = 0.0;
  pendingOrdersAmount = 0.0;

  loggedUser: User = {} as any;
  accountUser: User = {} as any;
  ...
  async ngAfterViewInit() {
    ...
    // this.loadStoresBySeller();

    this.loggedUser = await this.userService.getLoggedUserLocal();
    this.accountUser = await this.userService.getSelectedUserLocal();
    this.isAdmin = await this.adminService.selectedUserHasRole(USER_ROLE.ADMIN);

    this.accountUser = this.loggedUser;
  }
